...
This is an open letter of gratitude to some wonderful people. For a handful of reasons, I really admire them and they have significantly influenced my dreams and core values.
...
The influence of quirky fun facts is easily understated. What they really do, and what Annie's work on DoW has achieved spectacularly, is help reduce "unknown unknowns." That is, they illuminate meaning which previously could not even be identifed, let alone appreciated, by enabling introductions into new and unfamiliar topics of understanding.

This flavor of exploratory education is invaluable in effecting motivation. Having an upfront target topic, as we more typically do, limits how surprised, excited, or challenged you can be. However, it's hard to reduce unknown unknowns alone. The difficulty has historically been on teachers to figure out which missing concepts their students need and teach them. Kudos to teachers who take that challenge seriously. But, arguably, Annie's work with DoW has positively affected many times more students than most teachers can.

Performing the research that answers the questions that various people didn't know they had is a beautiful and essential calling. The delight I receive from Depths of Wiki helped inspire the creation of [FITM](https://fitm.online).
...
Mark's trading journey is unique and inspiring. He learned about speculation in the 1980s as an independent, uneducated (dropped out of high school) rock drummer. He struggled for years while self-teaching, analyzing price quotes he recorded by hand from newspapers. (Bear in mind it was also common then for transaction commissions to cost a few hundred dollars each.) He endured for 6 years and crawled into profitability. In 1997 Mark became the US Investing Champion, and again in 2021. His Minervini Private Access program students often [perform well in USIC competitions](https://www.businesswire.com/news/home/20250127956815/en/2024-United-States-Investing-Championship-Final-Results) too.
...
Incidentally, in the decade-plus and thousands of matches I have experienced as a player and spectator, Justin Wong is the only player I have ever seen to attempt&mdash;let alone pull off&mdash;the same-side overhead mixup from the Evo 2013 clip linked above. It's extremely risky&mdash;certain death if anticipated. He did it twice as far as I know: once then against Flocker, and once more [here](https://youtu.be/ojYshX0FOBg?si=KqFPASucShQap0gn&t=95) in 2022 against Chris G, nearly 10 years later. Chris G is another Evo champion and multi-time finalist who is known for composure and defensive skill; Chris G blocks everything. The absurdness of attempting that mixup, twice, against these two titan-like players, including in the final rounds of the world's largest tournament, waiting a decade in-between, and it actually succeeding both times, is hilariously epic.

### Tim Ferriss

[Tim Ferriss](https://tim.blog/) does many things, but I am most grateful for his effort into _The Tim Ferriss Show_. Like [Annie Rauwerda]({{< ref "/idols#annie-rauwerda-depths-of-wikipedia">}}), Tim is one of the best at discovering "unknown unknowns" and curating them into fun and valuable snack packets for the curious. His podcasts are typically interviews/conversations and demonstrate considerable diversity in guest backgrounds. It has by far the highest-quality average episode of the shows I've tried.
...
Tim is the author of several outstanding books and has introduced others (both by direct recommendation and by bringing on guests who recommend them) that I have loved. A few noteworthy examples are [_Vagabonding_](https://rolfpotts.com/books/vagabonding/) by Rolf Potts and [_Anything You Want_](https://sive.rs/a) by Derek Sivers. Tim's own works tend to focus on performance optimization and, compared to alternatives in that genre, are generous in humor and good spirit. He is transparent about personal struggles, endeavoring not to come off as an "unflappable juggernaut" (his own great phrasing). That authenticity amounts to fun and compelling narratives. That being said, Tim's tomes are about as potent as Everclear; they will incapacitate you by delivering shocking concentrations of valuable insight and majestic fact. His skillful wording, both in writing (see aforementioned example) and in discussions with podcastees, is a treat, and his zest for life is highly contagious. I recommend trying Tim's [podcast](https://open.spotify.com/show/5qSUyCrk9KR69lEiXbjwXM) or [blog](https://tim.blog/blog/page/2/#categories-2) if you haven't already.

### Paul Graham

[Paul Graham](https://www.paulgraham.com/) (PG)'s brilliant and prolific rhetoric has nudged me to both contemplate more thoroughly and write more in public. PG [writes a lot](https://www.paulgraham.com/articles.html) online and his essays constitute a trove of clear, logical, and practical thinking. Some of my favorites are [_How to Write Usefully_](https://paulgraham.com/useful.html), [_How to Do What You Love_](https://paulgraham.com/love.html), and [_Maker's Schedule, Manager's Schedule_](https://paulgraham.com/makersschedule.html). I don't know of another author having both the technical knowledge and appetite for dissecting psychology and behavior that PG does. (That of course doesn't mean that there isn't one.)

For the invention of [Hacker News](https://news.ycombinator.com/), a precious gem of the Internet and one of my most frequented sites, PG deserves many thanks. He is also known for founding and raising [YCombinator](https://www.ycombinator.com/). I don't tend to glorify venture capital but some companies and nonprofits that YC has backed are pretty cool, like Reddit, Stripe, [80,000 Hours](https://80000hours.org/about/), and most of their nonprofit lineup.

Despite great success, as Borat would say, PG demonstrates humility, compassion, and eagerness to see good fortune fall into the hands of new subjects. I salute his commitment to improving broad quality of life through startup advising, readying Hacker News to become the epicenter of chivalrous and well-researched discussion that it is, and sharing his thoughtful excerpts with the world.

### Terry Crews

Terry Crews hardly needs an introduction. Why is he here? In short: Terry makes hard but mature choices.

[Admitting fault can be unpleasant](../trading). But in a core component of identity, accepting error takes lots of courage and purpose. For Terry to voluntarily sacrifice toughness, a key ingredient in his recipe for fame and success, to align with higher ideals and eventually discover a greater happiness even when the path of least resistance was to remain the same, is a real show of character.

Terry is also radically transparent about personal struggles, especially his personal [war against toxic aggression](https://www.amazon.com/Tough-My-Journey-True-Power/dp/0593329805). His early life didn't invite peace of mind (abusive father, football player, lauded for toughness, etc.), so it's incredible who Terry has managed to become. He is not just nonviolent&mdash;he is a worldwide icon of self-reflection, wisdom, and bravery.

Terry, like many I admire, has had plenty of chances to sell out but will not. He could have found other partners after his affair was discovered, without moving on from the habit of infidelity. He could have easily continued to live violently, since it's encouraged as a football star. He has been offered an easier and less honorable life many times but chooses instead to be a leader and example for others. In particular, men who are susceptible to the follies of instinctual toughness (yup, so all of us baboons) can learn from Terry's brilliance.
...
When my dad was a kid, she and grandpa would invite teenagers over from Buffalo inner-city group homes during the summers to play outside. The kids led troubled lives&mdash;some had earned prison sentences for heinous transgressions. Joyce and Sol did't care. They put it aside and gave the kids chances to be good guests and have fun, and that's what always happened.
